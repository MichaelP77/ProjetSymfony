...
class __TwigTemplate_d7c96d257b1613b83ff151a7d3eabd59 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        yield "<h1>Confirmer son mail</h1>

<p>
    Cliquez sur ce lien ci-dessous: <br><br>
    <a href=\"";
        // line 5
        ...
        yield "\">Confirmer mon mail</a>.
    Ce lien expirera dans ";
        // line 6
        yield Twig\Extension\EscaperExtension::escape($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans((isset($context["expiresAtMessageKey"]) || array_key_exists("expiresAtMessageKey", $context) ? $context["expiresAtMessageKey"] : (function () { throw new RuntimeError('Variable "expiresAtMessageKey" does not exist.', 6, $this->source); })()), (isset($context["expiresAtMessageData"]) || array_key_exists("expiresAtMessageData", $context) ? $context["expiresAtMessageData"] : (function () { throw new RuntimeError('Variable "expiresAtMessageData" does not exist.', 6, $this->source); })()), "VerifyEmailBundle"), "html", null, true);
        yield ".
</p>
";
    ...
    {
        return new Source("<h1>Confirmer son mail</h1>

<p>
    Cliquez sur ce lien ci-dessous: <br><br>
    <a href=\"{{ signedUrl|raw }}\">Confirmer mon mail</a>.
    Ce lien expirera dans {{ expiresAtMessageKey|trans(expiresAtMessageData, 'VerifyEmailBundle') }}.
</p>
", "registration/confirmation_email.html.twig", "C:\\xampp2\\htdocs\\symfony\\Projet\\templates\\registration\\confirmation_email.html.twig");
    }
}
